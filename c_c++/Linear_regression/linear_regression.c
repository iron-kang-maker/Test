...
int main(void)
{
	...
	f = popen("wc -l ex1data1.txt", "r");

	data 	= fopen("ex1data1.txt", "r");
...
//	printf("For population = 70,000, we predict a profit of %f\n",predict2*10000);
	...
	fprintf(linearPlot, "plot 'record' using 1:2 t \"Training Data\" ,");
	fprintf(linearPlot, "     'record' using 1:3 t \"Linear regression\" with linespoints\n");
...
//	fprintf(costPlot, "set cntrparam levels 20\n");
	...
	fprintf(costPlot, "splot 'cost' using 1:2:3 t \"Cost Function\" with lines\n");
