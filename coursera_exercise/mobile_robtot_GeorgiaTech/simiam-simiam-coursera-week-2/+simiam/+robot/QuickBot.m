...
%             obj.add_surface_with_alpha(qb_axle, [0.15 0.15 0.15], 0.5);
        ...
        function ir_distances = get_ir_distances(obj)
            ...
            fprintf('vol: %.3f, %.3f, %.3f, %.3f, %.3f\n', ir_voltages(1), ir_voltages(2), ir_voltages(3), ir_voltages(4), ir_voltages(5));
            ir_voltages_from_table = [2.75 2.35 2.05 1.75 1.55 1.40 1.275 1.075 0.925 0.805 0.725 0.650 0.50 0.40];
            ir_distances_from_table = [0.04 0.05 0.06 0.07 0.08 0.08 0.10 0.12 0.14 0.16 0.18 0.20 0.25 0.30];
